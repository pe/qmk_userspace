...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_iso_110(
        KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,     KC_MUTE,    G(S(KC_4)),  G(KC_SPC),  RGB_TOG,  KC_F16,   KC_MCTL,  G(KC_MCTL),  MC_LOCK,
        ...
        KC_LCTL,  KC_LOPT,  KC_LCMD,                                KC_SPC,                                 KC_RCMD,  KC_ROPT,  AP_GLOB,    KC_RCTL,    KC_LEFT,     KC_DOWN,    KC_RGHT,  KC_P0,              KC_PDOT,     KC_PENT),
    [MAC_FN] = LAYOUT_iso_110(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,  _______,  _______,    RGB_TOG,    _______,     _______,    _______,  _______,  _______,  _______,     _______,
